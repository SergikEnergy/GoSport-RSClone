...
export default class ProfilePage extends Page {
  ...
  const cardImageWrapper = createElement('div',cardWrapper,'d-flex justify-content-center align-items-center flex-column col-md-4 gradient-custom text-center text-white')
